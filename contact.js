...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (contactForm) {
        contactForm.addEventListener("submit", async function (e) {
            ...
            try {
                await emailjs.send("service_tdlc5cs", "template_7p5pu9k", adminParams);
                await emailjs.send("service_tdlc5cs", "template_9zmkpir", userParams);
